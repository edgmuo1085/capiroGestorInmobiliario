...
@Component({
  selector: 'app-avaluos-upload',
  templateUrl: './avaluos-upload.component.html',
  styleUrls: ['./avaluos-upload.component.scss'],
})
export class AvaluosUploadComponent implements OnDestroy {
